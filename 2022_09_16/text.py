def main():
    ...
    print(text.format(title=title, genre=genre, author=author, year=year, imdb=imdb, name_of_main_character=name_of_main_character,
          job=job_of_main_character, length_in_mins=length_in_mins, original_lang=original_lang))
