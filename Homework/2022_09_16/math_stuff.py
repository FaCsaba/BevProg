...
# Másodfokú egyenlet, doesn't handle edge cases!!
def masodfoku(a, b, c) -> Tuple[float, float]:
...
def main():
    ...
    print(weightedaverage(
        [{"weight": 25, "value": 75}, {"weight": 30, "value": 60}]))
    print(standard_deviation([9, 2, 5, 4, 12, 7, 8,
